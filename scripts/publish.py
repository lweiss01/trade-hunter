...
def main() -> None:
    ...
    # Version-agnostic default so it never carries a stale release theme forward.
    # Pass -m to give the commit/release a descriptive message per release.
    parser.add_argument("--message", "-m", default=f"Publish {VERSION}")
