...
from .config import ENV_PATH, Settings, persist_detector_thresholds, persist_kalshi_markets
...
class TradeHunterService:
    ...
    def add_kalshi_market(self, ticker: str) -> list[str]:
        ...
        with self._kalshi_lock:
            ...
            persist_kalshi_markets(self.settings.kalshi_markets, env_path=ENV_PATH)
