...
# Keys must match the tiers SpikeDetector actually emits: watch, notable,
# signal, whale-cluster, and cross-venue divergence. Missing keys fall back to
# the "watch" color, so the strongest alerts (signal/whale-cluster) previously
# rendered in the weak watch-yellow.
_TIER_COLORS = {
    "watch": 0xF4C542,
    "notable": 0xFF9B54,
    "signal": 0xFF6B57,
    "whale-cluster": 0x9B59B6,
