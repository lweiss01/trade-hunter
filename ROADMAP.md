...
- [x] **M014: Essential Security Controls** — Auth, CSRF, and injection hardening. (S01, S02)
- [x] **M015: Ingest Integrity** — Secure webhook authentication. (S01)
- [x] **M016: Security Awareness** — Regression test suite and automation. (S01)
