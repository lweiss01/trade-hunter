...
### Startup Notes For Antigravity

- Read the Holistic recap before steering Antigravity toward a new plan or implementation pass.

Use the repo-local Holistic helper in this repo: Windows `.\.holistic\system\holistic.cmd resume --agent antigravity`; macOS/Linux `./.holistic/system/holistic resume --agent antigravity`.
...
### Checkpoint Notes For Antigravity
