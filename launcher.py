...
def ensure_single_instance():
    ...
    # Version-independent single-instance lock. The name must stay stable across
    # releases: if it encoded the version, an old and a new build would hold
    # different mutexes and could run simultaneously during an upgrade.
    mutex_name = os.getenv("TRADE_HUNTER_MUTEX_NAME", "Global\\TradeHunter_SingleInstance")
...
def run_launcher():
    log_boot(f"--- ATOMIC BOOT {VERSION} ---")
