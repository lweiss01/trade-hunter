readme_content = """# Trade Hunter 🎯

**The institutional edge for prediction market flow.**

In prediction markets, alpha isn't just about knowing the news first—it's about seeing the money move before the news breaks. By the time a headline hits X (Twitter), the orderbook has already repriced. 
